...
@Model.register("base_constituency_parser_v2")
class BaseConstituencyParserV2(Model):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(BaseConstituencyParserV2, self).__init__(vocab, **kwargs)
    ...
    def forward(
        ...
        batch_size, seq_len, seq_lens = mask.size(0), mask.size(1)-2, mask.sum(1) - 2

        embedded_text_input = self.text_field_embedder(tokens)
        # embedded_text_input = self.var_dropout(embedded_text_input)
        ...
        # TODO: try alternatives, such as omitting position entirely
