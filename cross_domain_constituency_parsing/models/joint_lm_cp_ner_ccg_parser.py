...
from cross_domain_constituency_parsing.models.joint_lm_cp_ner_parser import (
    JointLMCPNERShareSpan3Parser, JointLMCPNERQKVShareSpan3Parser, JointLMCPNERShareParser, JointLMCPNERQKVShareParser)
import logging


logger = logging.getLogger(__name__)

@Model.register("joint_lm_cp_ner_ccg_share_parser")
class JointLMCPNERCCGShareParser(JointLMCPNERShareParser):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(JointLMCPNERCCGShareParser, self).__init__(
            vocab, text_field_embedder, encoder, span_extractor, lm_loss_weight, ner_loss_weight,
            initializer, **kwargs
        )

        self.ccg_proj = nn.Sequential(
    ...
    def forward(
        ...
        num_lm, num_cp, num_ner, num_ccg = lm_index.size(0), cp_index.size(0), ner_index.size(0), ccg_index.size(0)
        ...
        if num_ccg > 0:
            ccg_logits = self.ccg_head(self.ccg_proj(encoded_text[ccg_index, 1:-1, :]))
...
@Model.register("joint_lm_cp_ner_ccg_qkv_share_parser")
class JointLMCPNERCCGQKVShareParser(JointLMCPNERQKVShareParser):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(JointLMCPNERCCGQKVShareParser, self).__init__(
            vocab, text_field_embedder, encoder, span_extractor, lm_loss_weight, ner_loss_weight,
...
@Model.register("joint_lm_cp_ner_ccg_share_span3_parser")
class JointLMCPNERCCGShareSpan3Parser(JointLMCPNERShareSpan3Parser):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(JointLMCPNERCCGShareSpan3Parser, self).__init__(
            vocab, text_field_embedder, encoder, span_extractor, lm_loss_weight, ner_loss_weight,
            initializer, **kwargs)
...
@Model.register("joint_lm_cp_ner_ccg_qkv_share_span3_parser")
class JointLMCPNERCCGQKVShareSpan3Parser(JointLMCPNERQKVShareSpan3Parser):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(JointLMCPNERCCGQKVShareSpan3Parser, self).__init__(
            vocab, text_field_embedder, encoder, span_extractor, lm_loss_weight, ner_loss_weight,
            share_loss_weight, domain_loss_weight, task_loss_weight, initializer, **kwargs)
...
@Model.register("joint_lm_cp_ner_ccg_share_span3_parser_training2")
class JointLMCPNERCCGShareSpan3ParserTraining2(JointLMCPNERShareSpan3Parser):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(JointLMCPNERCCGShareSpan3ParserTraining2, self).__init__(
            vocab, text_field_embedder, encoder, span_extractor, lm_loss_weight, ner_loss_weight,
            initializer, **kwargs)
    ...
    def forward(
        ...
        for i in range(task.size(0)):
            if task[i] != self.vocab.get_token_index("constituency_parsing", "task_labels"):
                if np.random.rand() <= 0.5:
                    task[i] = self.vocab.get_token_index("constituency_parsing", "task_labels")
        ...
        lm_label = self.language_model_share_mask(tokens, lm_index)
