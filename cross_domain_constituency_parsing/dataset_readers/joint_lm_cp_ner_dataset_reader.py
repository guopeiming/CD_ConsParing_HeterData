...
@DatasetReader.register("joint_lm_cp_ner_parser")
class JointLMCPNERParserDatasetReader(DatasetReader):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(JointLMCPNERParserDatasetReader, self).__init__(**kwargs)
...
@DatasetReader.register("joint_lm_cp_ner_span_parser")
class JointLMCPNERSpanParserDatasetReader(JointLMCPNERParserDatasetReader):
