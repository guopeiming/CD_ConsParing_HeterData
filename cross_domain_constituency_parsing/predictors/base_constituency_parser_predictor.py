...
@Predictor.register("BaseConstituencyParser")
class BaseConstituencyParserPredictor(Predictor):
    """
    Predictor for the graph-based model.
    """
    ...
    def _json_to_instance(self, json_dict: JsonDict) -> Instance:
        return self._dataset_reader.text_to_instance(
            json_dict["tokens"], json_dict["postags"]
        )
